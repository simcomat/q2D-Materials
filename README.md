...
| ![RP plan](Examples/images/rp_glazer_top.png) ![RP side](Examples/images/rp_base_side.png) ![RP iso](Examples/images/rp_atomic_side.png) | **Multi-view structural analysis** – Shows different Ruddlesden-Popper structure from plan, elevation, and isometric perspectives, highlighting stepped layer architectures and surface termination. |
